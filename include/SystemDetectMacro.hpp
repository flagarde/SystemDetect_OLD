...
#define C_COMPILER_PATCH_VERSION(PATCH)(PATCH == @C_COMPILER_VERSION_PATCH@)
...
#define CXX_COMPILER_PATCH_VERSION(PATCH)(PATCH == @CXX_COMPILER_VERSION_PATCH@)

#define IS_BIG_ENDIAN @ENDIANNESS@
#define IS_LITTLE_ENDIAN !@ENDIANNESS@
// clang-format on
